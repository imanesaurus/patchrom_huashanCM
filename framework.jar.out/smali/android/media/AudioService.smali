...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v0, Landroid/media/AudioService$11;

    invoke-direct {v0, p0}, Landroid/media/AudioService$11;-><init>(Landroid/media/AudioService;)V
    ...
    new-instance v0, Landroid/media/AudioService$12;

    invoke-direct {v0, p0}, Landroid/media/AudioService$12;-><init>(Landroid/media/AudioService;)V
...
.method static synthetic access$10000(Landroid/media/AudioService;Landroid/os/IBinder;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$8802(Landroid/media/AudioService;Landroid/app/KeyguardManager;)Landroid/app/KeyguardManager;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$8900(Landroid/media/AudioService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method private adjustRemoteVolume(III)V
    ...
    :cond_1
    invoke-direct {p0, p1, p3}, Landroid/media/AudioService;->remoteVolumeChanged(II)V
...
.method private canReassignAudioFocusTo(Ljava/lang/String;)Z
    .locals 3
    .parameter "clientId"
...
.method private displaySafeVolumeWarning()V
    ...
    new-instance v1, Landroid/media/AudioService$9;

    invoke-direct {v1, p0}, Landroid/media/AudioService$9;-><init>(Landroid/media/AudioService;)V
...
.method private hasNewRemotePlaybackInfo()V
    .locals 2
    ...
    invoke-virtual {v0}, Landroid/view/VolumePanel;->postHasNewRemotePlaybackInfo()V
    ...
    new-instance v1, Landroid/media/AudioService$10;

    invoke-direct {v1, p0}, Landroid/media/AudioService$10;-><init>(Landroid/media/AudioService;)V
...
.method private notifyTopOfAudioFocusStack()V
    ...
    iget-object v0, v2, Landroid/media/AudioService$FocusStackEntry;->mClientId:Ljava/lang/String;

    .local v0, clientId:Ljava/lang/String;
    invoke-direct {p0, v0}, Landroid/media/AudioService;->canReassignAudioFocusTo(Ljava/lang/String;)Z
    ...
    invoke-interface {v2, v3, v0}, Landroid/media/IAudioFocusDispatcher;->dispatchAudioFocusChange(ILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "Failure to signal gain of audio control focus due to "
...
.method private onNewPlaybackInfoForRcc(III)V
    ...
    invoke-direct {p0}, Landroid/media/AudioService;->hasNewRemotePlaybackInfo()V
...
.method private onReevaluateRemote()V
    ...
    invoke-direct {p0, v0}, Landroid/media/AudioService;->remoteSliderVisibility(Z)V
...
.method private readPersistedSettings()V
    ...
    :try_start_1
    iget-object v4, p0, Landroid/media/AudioService;->mCameraSoundForced:Ljava/lang/Boolean;
    ...
    invoke-static {v0, v4, v7, v9}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
...
.method private remoteSliderVisibility(Z)V
    .locals 2
    .parameter "hasRemotePlayback"
    ...
    invoke-virtual {v0, p1}, Landroid/view/VolumePanel;->postRemoteSliderVisibility(Z)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/media/AudioService$6;-><init>(Landroid/media/AudioService;Z)V
...
.method private remoteVolumeChanged(II)V
    .locals 2
    .parameter "streamType"
    .parameter "flags"
    ...
    invoke-virtual {v0, p1, p2}, Lmiui/view/VolumePanel;->postRemoteVolumeChanged(II)V
    ...
    new-instance v1, Landroid/media/AudioService$8;

    invoke-direct {v1, p0, p1, p2}, Landroid/media/AudioService$8;-><init>(Landroid/media/AudioService;II)V
...
.method private showVolumeChangeUi(II)V
    ...
    invoke-direct {v1, p0, p1, p2}, Landroid/media/AudioService$7;-><init>(Landroid/media/AudioService;II)V
...
.method public setStreamVolume(III)V
    ...
    iget v6, p0, Landroid/media/AudioService;->mLastSilentRingerMode:I
