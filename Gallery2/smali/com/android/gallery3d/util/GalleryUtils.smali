...
.method public static isGeolocationViewAvailable(Landroid/content/Context;)Z
    .locals 9
    .parameter "context"
    ...
    .line 315
    .local v2, gmmCompName:Landroid/content/ComponentName;
    const-string v5, "http://maps.google.com/maps?f=q&q=(%f,%f)"

    invoke-static {v5, v7, v8, v7, v8}, Lcom/android/gallery3d/util/GalleryUtils;->formatLatitudeLongitude(Ljava/lang/String;DD)Ljava/lang/String;

    move-result-object v4

    .line 317
    .local v4, gmmUri:Ljava/lang/String;
    new-instance v3, Landroid/content/Intent;

    invoke-direct {v3}, Landroid/content/Intent;-><init>()V

    .line 318
    .local v3, gmmIntent:Landroid/content/Intent;
    ...
    .line 325
    .local v0, geoIntent:Landroid/content/Intent;
    ...
    .line 329
    invoke-static {p0, v3}, Lcom/android/gallery3d/util/GalleryUtils;->isIntentResolved(Landroid/content/Context;Landroid/content/Intent;)Z

    move-result v5

    if-nez v5, :cond_0

    invoke-static {p0, v0}, Lcom/android/gallery3d/util/GalleryUtils;->isIntentResolved(Landroid/content/Context;Landroid/content/Intent;)Z
...
.method private static isIntentResolved(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    .line 334
    .local v1, pckMgr:Landroid/content/pm/PackageManager;
    const/16 v2, 0x40
...
.method public static showOnMap(Landroid/content/Context;DD)V
    ...
    const-string v6, "GMM activity not found! Trying with geo scheme"
